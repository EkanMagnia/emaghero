...
class LuckService implements Luck {
	...
	/**
	 * We can aproach luck in a simple manner by generating a number btw 0 and 100, and comparing it with the player's luck.
	 * For example, if the player luck is 30 and the generated number is <30, then we return true, otherwise false.
	 *
